...
handles.output_file = 'user_results_shikhar.txt';
handles.input_dir = 'D:\Documents\Tiles_Norm\Human_ranking';
%im2 = imread(char(norm_pairs{handles.count, 'Target'})); 
im3 = imread(fullfile(handles.input_dir,char(handles.norm_pairs{handles.count, 'm1'}))); 
im4 = imread(fullfile(handles.input_dir,char(handles.norm_pairs{handles.count, 'm2'})));
...
handles.axes14.Color = handles.count_colors{5};
