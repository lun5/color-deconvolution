function [ purple_manual,pink_manual ] = deconvolutionManual( imname, datadir, resultdir, options,  varargin)
...
stain_mat_man = [purple_manual pink_manual]; % do i need to normalize this?
