...
seg_dir = fullfile(data_dir,'seg_results');
mask_dir = fullfile(data_dir,'masks');
if ~exist(seg_dir,'dir'); mkdir(seg_dir); end
adj_dir = fullfile(data_dir,'Tiles_Norm_withAdjDelasnew');
param_str = '_se1_minNuc3_minStr5_minLum5';

for mm = 2:length(method_names)
    tic;
    curr_im_dir = fullfile(im_dir,method_names{mm});
    curr_adj_dir = fullfile(adj_dir,'Tiles_512_output',method_names{mm});
    ...
    for ii = 1:num_im
        ...
        %imname = '2ale5ngryfnpo-hrdqmlu2ig';
