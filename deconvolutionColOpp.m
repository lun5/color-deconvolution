...
% Author: Luong Nguyen
% Modified 4/9/14
function [ stain1_sic, stain2_sic, saturation_mat] = deconvolutionColOpp(imname,datadir,resultdir, rotation_matrix, options, varargin) 
...
indx_min = (abs(sic_image(1,:) - extreme_values(1)) < 1e-2) & (~ indx_sat);
indx_max = (abs(sic_image(1,:) - extreme_values(2)) < 1e-2) & (~ indx_sat);
