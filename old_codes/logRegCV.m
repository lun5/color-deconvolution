...
% purple
figure;
scatter(X_purple_oppCol(1,:), X_purple_oppCol(2,:),20,X_purple_rgb'./255,'filled'); 
axis([-1 1 -1 1])

% pink
figure;
scatter(X_pink_oppCol(1,:), X_pink_oppCol(2,:),20,X_pink_rgb'./255,'filled');
axis([-1 1 -1 1])