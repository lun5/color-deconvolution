...
path_matlab='C:\Program Files\MATLAB\R2014b';
...
if strcmp(compiler,'gcc') 
    if linux || mac
       ...
       path_to_compiler_libraries='C:\cygwin64\lib\gcc\x86_64-pc-cygwin\5.4.0';
    end
...
elseif strcmp(compiler,'vs')
    ...
    path_to_compiler_libraries='C:\Program Files (x86)\Microsoft Visual Studio 12.0\VC\bin\amd64';
...
COMPILE = { 
            ...
            '-ID:\Documents\MATLAB\spams-matlab\linalg -ID:\Documents\MATLAB\spams-matlab\decomp -ID:\Documents\MATLAB\spams-matlab\prox -ID:\Documents\MATLAB\spams-matlab\dictLearn spams-matlab/dictLearn/mex/mexArchetypalAnalysis.cpp', 
            '-ID:\Documents\MATLAB\spams-matlab\linalg -ID:\Documents\MATLAB\spams-matlab\decomp -ID:\Documents\MATLAB\spams-matlab\prox -ID:\Documents\MATLAB\spams-matlab\dictLearn spams-matlab/dictLearn/mex/mexTrainDL.cpp', 
            '-ID:\Documents\MATLAB\spams-matlab\linalg -ID:\Documents\MATLAB\spams-matlab\decomp -ID:\Documents\MATLAB\spams-matlab\prox -ID:\Documents\MATLAB\spams-matlab\dictLearn spams-matlab/dictLearn/mex/mexStructTrainDL.cpp', 
            '-ID:\Documents\MATLAB\spams-matlab\linalg -ID:\Documents\MATLAB\spams-matlab\decomp -ID:\Documents\Tiles_Norm\spams-matlab\prox -ID:\Documents\Tiles_Norm\spams-matlab\dictLearn spams-matlab/dictLearn/mex/mexTrainDL_Memory.cpp',
            % compile dag toolbox
            '-ID:\Documents\Tiles_Norm\spams-matlab\dags -ID:\Documents\Tiles_Norm\spams-matlab\linalg spams-matlab/dags/mex/mexRemoveCyclesGraph.cpp',
            '-ID:\Documents\Tiles_Norm\spams-matlab\dags -ID:\Documents\Tiles_Norm\spams-matlab\linalg spams-matlab/dags/mex/mexCountPathsDAG.cpp',
            '-ID:\Documents\Tiles_Norm\spams-matlab\dags -ID:\Documents\Tiles_Norm\spams-matlab\linalg spams-matlab/dags/mex/mexCountConnexComponents.cpp',
            % compile proximal toolbox
            '-ID:\Documents\Tiles_Norm\spams-matlab\linalg -ID:\Documents\Tiles_Norm\spams-matlab\prox spams-matlab/prox/mex/mexIncrementalProx.cpp',
            '-ID:\Documents\Tiles_Norm\spams-matlab\linalg -ID:\Documents\Tiles_Norm\spams-matlab\prox spams-matlab/prox/mex/mexStochasticProx.cpp',
            '-ID:\Documents\Tiles_Norm\spams-matlab\linalg -ID:\Documents\Tiles_Norm\spams-matlab\prox spams-matlab/prox/mex/mexFistaFlat.cpp',
            '-ID:\Documents\Tiles_Norm\spams-matlab\linalg -ID:\Documents\Tiles_Norm\spams-matlab\prox spams-matlab/prox/mex/mexFistaTree.cpp',  
            '-ID:\Documents\Tiles_Norm\spams-matlab\linalg -ID:\Documents\Tiles_Norm\spams-matlab\prox spams-matlab/prox/mex/mexFistaGraph.cpp',  
            '-ID:\Documents\Tiles_Norm\spams-matlab\linalg -ID:\Documents\Tiles_Norm\spams-matlab\prox spams-matlab/prox/mex/mexFistaPathCoding.cpp',  
            '-ID:\Documents\Tiles_Norm\spams-matlab\linalg -ID:\Documents\Tiles_Norm\spams-matlab\prox spams-matlab/prox/mex/mexProximalFlat.cpp', 
            '-ID:\Documents\Tiles_Norm\spams-matlab\linalg -ID:\Documents\Tiles_Norm\spams-matlab\prox spams-matlab/prox/mex/mexProximalTree.cpp',  
            '-ID:\Documents\Tiles_Norm\spams-matlab\linalg -ID:\Documents\Tiles_Norm\spams-matlab\prox spams-matlab/prox/mex/mexProximalGraph.cpp',
            '-ID:\Documents\Tiles_Norm\spams-matlab\linalg -ID:\Documents\Tiles_Norm\spams-matlab\prox spams-matlab/prox/mex/mexProximalPathCoding.cpp',  
            '-ID:\Documents\Tiles_Norm\spams-matlab\linalg -ID:\Documents\Tiles_Norm\spams-matlab\prox spams-matlab/prox/mex/mexEvalPathCoding.cpp',  
            % compile linalg toolbox
            '-ID:\Documents\Tiles_Norm\spams-matlab\linalg spams-matlab/linalg/mex/mexCalcAAt.cpp',
            '-ID:\Documents\Tiles_Norm\spams-matlab\linalg spams-matlab/linalg/mex/mexCalcXAt.cpp',  
            '-ID:\Documents\Tiles_Norm\spams-matlab\linalg spams-matlab/linalg/mex/mexCalcXY.cpp',  
            '-ID:\Documents\Tiles_Norm\spams-matlab\linalg spams-matlab/linalg/mex/mexCalcXYt.cpp', 
            '-ID:\Documents\Tiles_Norm\spams-matlab\linalg spams-matlab/linalg/mex/mexCalcXtY.cpp',  
            '-ID:\Documents\Tiles_Norm\spams-matlab\linalg spams-matlab/linalg/mex/mexConjGrad.cpp',  
            '-ID:\Documents\Tiles_Norm\spams-matlab\linalg spams-matlab/linalg/mex/mexInvSym.cpp',  
            '-ID:\Documents\Tiles_Norm\spams-matlab\linalg spams-matlab/linalg/mex/mexSort.cpp', 
            '-ID:\Documents\Tiles_Norm\spams-matlab\linalg spams-matlab/linalg/mex/mexNormalize.cpp',  
            % compile decomp toolbox
            '-ID:\Documents\Tiles_Norm\spams-matlab\linalg -ID:\Documents\Tiles_Norm\spams-matlab\dictLearn -ID:\Documents\Tiles_Norm\spams-matlab\decomp spams-matlab/decomp/mex/mexDecompSimplex.cpp', 
            '-ID:\Documents\Tiles_Norm\spams-matlab\linalg -ID:\Documents\Tiles_Norm\spams-matlab\decomp spams-matlab/decomp/mex/mexOMP.cpp',
            '-ID:\Documents\Tiles_Norm\spams-matlab\linalg -ID:\Documents\Tiles_Norm\spams-matlab\decomp spams-matlab/decomp/mex/mexLasso.cpp',
            '-ID:\Documents\Tiles_Norm\spams-matlab\linalg -ID:\Documents\Tiles_Norm\spams-matlab\decomp spams-matlab/decomp/mex/mexLassoWeighted.cpp',
            '-ID:\Documents\Tiles_Norm\spams-matlab\linalg -ID:\Documents\Tiles_Norm\spams-matlab\decomp spams-matlab/decomp/mex/mexRidgeRegression.cpp',
            '-ID:\Documents\Tiles_Norm\spams-matlab\linalg -ID:\Documents\Tiles_Norm\spams-matlab\decomp spams-matlab/decomp/mex/mexCD.cpp'
            '-ID:\Documents\Tiles_Norm\spams-matlab\linalg -ID:\Documents\Tiles_Norm\spams-matlab\decomp spams-matlab/decomp/mex/mexL1L2BCD.cpp', 
            '-ID:\Documents\Tiles_Norm\spams-matlab\linalg -ID:\Documents\Tiles_Norm\spams-matlab\decomp spams-matlab/decomp/mex/mexLassoMask.cpp',
            '-ID:\Documents\Tiles_Norm\spams-matlab\linalg -ID:\Documents\Tiles_Norm\spams-matlab\decomp spams-matlab/decomp/mex/mexOMPMask.cpp',
            '-ID:\Documents\Tiles_Norm\spams-matlab\linalg -ID:\Documents\Tiles_Norm\spams-matlab\decomp spams-matlab/decomp/mex/mexSOMP.cpp',
            '-ID:\Documents\Tiles_Norm\spams-matlab\linalg -ID:\Documents\Tiles_Norm\spams-matlab\decomp spams-matlab/decomp/mex/mexSparseProject.cpp',
            % compile image toolbox
            '-ID:\Documents\Tiles_Norm\spams-matlab\image -ID:\Documents\Tiles_Norm\spams-matlab\linalg -ID:\Documents\Tiles_Norm\spams-matlab\prox spams-matlab/image/mex/mexConvFista.cpp', 
            '-ID:\Documents\Tiles_Norm\spams-matlab\image -ID:\Documents\Tiles_Norm\spams-matlab\linalg spams-matlab/image/mex/mexExtractPatches.cpp', 
            '-ID:\Documents\Tiles_Norm\spams-matlab\image -ID:\Documents\Tiles_Norm\spams-matlab\linalg spams-matlab/image/mex/mexCombinePatches.cpp', 
            % misc
            '-ID:\Documents\Tiles_Norm\spams-matlab\linalg spams-matlab/linalg/mex/mexBayer.cpp',
            '-ID:\Documents\Tiles_Norm\spams-matlab\linalg -ID:\Documents\Tiles_Norm\spams-matlab\prox spams-matlab/prox/mex/mexGraphOfGroupStruct.cpp',  
            '-ID:\Documents\Tiles_Norm\spams-matlab\linalg -ID:\Documents\Tiles_Norm\spams-matlab\prox spams-matlab/prox/mex/mexGroupStructOfString.cpp',  
            '-ID:\Documents\Tiles_Norm\spams-matlab\linalg -ID:\Documents\Tiles_Norm\spams-matlab\prox spams-matlab/prox/mex/mexReadGroupStruct.cpp',  
            '-ID:\Documents\Tiles_Norm\spams-matlab\linalg -ID:\Documents\Tiles_Norm\spams-matlab\prox spams-matlab/prox/mex/mexSimpleGroupTree.cpp',  
            '-ID:\Documents\Tiles_Norm\spams-matlab\linalg -ID:\Documents\Tiles_Norm\spams-matlab\prox spams-matlab/prox/mex/mexTreeOfGroupStruct.cpp'};
...
elseif strcmp(blas,'builtin')
   ...
   %blas_link=sprintf(' -L%s -L/usr/lib/ -lmwblas -lmwlapack',path_to_blas);
   DEFBLAS='-DUSE_BLAS_LIB';
elseif strcmp(blas,'acml')
