...
COMPILE = { 
            ...
            '-I./linalg/ -I./decomp/ -I./prox/ -I./dictLearn/ spams-matlab/dictLearn/mex/mexArchetypalAnalysis.cpp', 
            '-I./linalg/ -I./decomp/ -I./prox/ -I./dictLearn/ spams-matlab/dictLearn/mex/mexTrainDL.cpp', 
            '-I./linalg/ -I./decomp/ -I./prox/ -I./dictLearn/ spams-matlab/dictLearn/mex/mexStructTrainDL.cpp', 
            '-I./linalg/ -I./decomp/ -I./prox/ -I./dictLearn/ spams-matlab/dictLearn/mex/mexTrainDL_Memory.cpp',
            % compile dag toolbox
            '-I./dags/ -I./linalg/ spams-matlab/dags/mex/mexRemoveCyclesGraph.cpp',
            '-I./dags/ -I./linalg/ spams-matlab/dags/mex/mexCountPathsDAG.cpp',
            '-I./dags/ -I./linalg/ spams-matlab/dags/mex/mexCountConnexComponents.cpp',
            % compile proximal toolbox
            '-I./linalg/ -I./prox/ spams-matlab/prox/mex/mexIncrementalProx.cpp',
            '-I./linalg/ -I./prox/ spams-matlab/prox/mex/mexStochasticProx.cpp',
            '-I./linalg/ -I./prox/ spams-matlab/prox/mex/mexFistaFlat.cpp',
            '-I./linalg/ -I./prox/ spams-matlab/prox/mex/mexFistaTree.cpp',  
            '-I./linalg/ -I./prox/ spams-matlab/prox/mex/mexFistaGraph.cpp',  
            '-I./linalg/ -I./prox/ spams-matlab/prox/mex/mexFistaPathCoding.cpp',  
            '-I./linalg/ -I./prox/ spams-matlab/prox/mex/mexProximalFlat.cpp', 
            '-I./linalg/ -I./prox/ spams-matlab/prox/mex/mexProximalTree.cpp',  
            '-I./linalg/ -I./prox/ spams-matlab/prox/mex/mexProximalGraph.cpp',
            '-I./linalg/ -I./prox/ spams-matlab/prox/mex/mexProximalPathCoding.cpp',  
            '-I./linalg/ -I./prox/ spams-matlab/prox/mex/mexEvalPathCoding.cpp',  
            % compile linalg toolbox
            '-I./linalg/ spams-matlab/linalg/mex/mexCalcAAt.cpp',
            '-I./linalg/ spams-matlab/linalg/mex/mexCalcXAt.cpp',  
            '-I./linalg/ spams-matlab/linalg/mex/mexCalcXY.cpp',  
            '-I./linalg/ spams-matlab/linalg/mex/mexCalcXYt.cpp', 
            '-I./linalg/ spams-matlab/linalg/mex/mexCalcXtY.cpp',  
            '-I./linalg/ spams-matlab/linalg/mex/mexConjGrad.cpp',  
            '-I./linalg/ spams-matlab/linalg/mex/mexInvSym.cpp',  
            '-I./linalg/ spams-matlab/linalg/mex/mexSort.cpp', 
            '-I./linalg/ spams-matlab/linalg/mex/mexNormalize.cpp',  
            % compile decomp toolbox
            '-I./linalg/ -I./dictLearn/ -I./decomp/ spams-matlab/decomp/mex/mexDecompSimplex.cpp', 
            '-I./linalg/ -I./decomp/ spams-matlab/decomp/mex/mexOMP.cpp',
            '-I./linalg/ -I./decomp/ spams-matlab/decomp/mex/mexLasso.cpp',
            '-I./linalg/ -I./decomp/ spams-matlab/decomp/mex/mexLassoWeighted.cpp',
            '-I./linalg/ -I./decomp/ spams-matlab/decomp/mex/mexRidgeRegression.cpp',
            '-I./linalg/ -I./decomp/ spams-matlab/decomp/mex/mexCD.cpp'
            '-I./linalg/ -I./decomp/ spams-matlab/decomp/mex/mexL1L2BCD.cpp', 
            '-I./linalg/ -I./decomp/ spams-matlab/decomp/mex/mexLassoMask.cpp',
            '-I./linalg/ -I./decomp/ spams-matlab/decomp/mex/mexOMPMask.cpp',
            '-I./linalg/ -I./decomp/ spams-matlab/decomp/mex/mexSOMP.cpp',
            '-I./linalg/ -I./decomp/ spams-matlab/decomp/mex/mexSparseProject.cpp',
            % compile image toolbox
            '-I./image/ -I./linalg/ -I./prox/ spams-matlab/image/mex/mexConvFista.cpp', 
            '-I./image/ -I./linalg/ spams-matlab/image/mex/mexExtractPatches.cpp', 
            '-I./image/ -I./linalg/ spams-matlab/image/mex/mexCombinePatches.cpp', 
            % misc
            '-I./linalg/ spams-matlab/linalg/mex/mexBayer.cpp',
            '-I./linalg/ -I./prox/ spams-matlab/prox/mex/mexGraphOfGroupStruct.cpp',  
            '-I./linalg/ -I./prox/ spams-matlab/prox/mex/mexGroupStructOfString.cpp',  
            '-I./linalg/ -I./prox/ spams-matlab/prox/mex/mexReadGroupStruct.cpp',  
            '-I./linalg/ -I./prox/ spams-matlab/prox/mex/mexSimpleGroupTree.cpp',  
            '-I./linalg/ -I./prox/ spams-matlab/prox/mex/mexTreeOfGroupStruct.cpp'};
